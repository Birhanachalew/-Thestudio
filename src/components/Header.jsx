    ...
    <header ref={head} className="transform -translate-x-1/2 max-w-[1500px] flex bg-[#111111] border-b-2 border-transparent justify-between items-center w-full py-[15px] px-3 lg:px-10 fixed top-0 left-1/2  z-900">
      <div id="logo" className="flex items-center">
        <img
          ...
          className="w-[7rem] sm:w-[8rem] lg:w-[9rem] h-auto object-contain"
        />
      </div>
        ...
        <div className="Second-nav hidden lg:flex  gap-10">
          <ul className="flex items-center gap-10  text-[1.1rem] font-medium uppercase">
            ...
            >
              ...
              <div
                ref={ItemsBox}
                className="absolute top-[100%] left-0 w-[260px] h-[0px] opacity-0 overflow-hidden bg-white rounded-lg text-[0.92rem] text-black px-4 pt-1 pb-1 cursor-default hidden lg:block"
              >

                {/* ANIMATION & IMAGING EDUCATION */}
                <ul className="flex flex-col lg:py-[0.7rem] lg:gap-[0.3rem] border-b border-zinc-400">
                  <li className="text-[0.75rem] font-semibold text-zinc-500 uppercase mb-1">
                    Animation Courses
                  </li>
                ...
                <ul className="flex flex-col lg:py-[0.7rem] lg:gap-[0.3rem]">
                  <li className="text-[0.75rem] font-semibold text-zinc-500 uppercase mb-1">
                    Storytelling
                  </li>
          ...
          <div className="Wrapper-Div mt-[10vw] sm:mt-[2rem] h-[80%] flex items-center"> 
            ...
            <div ref={WhatMenu} className="hidden flex-col gap-[2vw] sm:gap-[0rem] w-full">
              ...
              <ul className="w-full sm:mt-[2rem]">
                ...
                {/* ANIMATION COURSES */}
                <MenuItems val={"2D Animation"} />
                <MenuItems val={"Stop Motion"} />
                <MenuItems val={"3D Modeling"} />
                <MenuItems val={"Digital Imaging"} />

                {/* PRODUCTION SERVICES */}
                <MenuItems val={"Media Production"} />
                <MenuItems val={"Animation Production"} />
                <MenuItems val={"Creative Content"} />

                {/* STORYTELLING */}
                <MenuItems val={"Creative Writing"} />
                <MenuItems val={"Visual Storytelling"} />
                <MenuItems val={"Narrative Development"} />
